...
export const Default: Story = {
  args: {
    ...
    stickyButtons: [
      ...
      { label: 'Chat to a student', href: 'https://sheffield.ac.uk/study/chat', iconClass: 'fas fa-comments' },
    ],
  },
};
...
export const Accredited: Story = {
  args: {
    ...
    courseIntro:
      'Develop essential research and analytical skills for evaluating health services and public health interventions, laying a solid foundation for a PhD or an academic career in public health.',
    startDate: 'September 2026',
