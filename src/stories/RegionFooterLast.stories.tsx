...
import { RegionFooterLast } from '../components/RegionFooterLast';

const meta: Meta<typeof RegionFooterLast> = {
  title: 'Components/RegionFooterLast',
  component: RegionFooterLast,
  tags: ['autodocs'],
};

export default meta;
type Story = StoryObj<typeof RegionFooterLast>;
